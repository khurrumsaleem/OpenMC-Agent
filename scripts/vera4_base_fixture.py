...
def build_vera4_universes() -> UniversesPatch:
    ...
    return UniversesPatch(universes=[
        ...
        UniverseSpecPatch(
            ...
            cells=[
                CellLayerPatch(id="inner_helium", role="gas_gap", material_id="helium",
                               region_kind="cylinder", r_min_cm=0.0, r_max_cm=0.2140),
                CellLayerPatch(id="inner_tube", role="cladding", material_id="ss304",
                               region_kind="annulus", r_min_cm=0.2140, r_max_cm=0.2310),
                CellLayerPatch(id="inner_gap", role="gas_gap", material_id="helium",
                               region_kind="annulus", r_min_cm=0.2310, r_max_cm=0.2410),
                CellLayerPatch(id="pyrex", role="poison", material_id="pyrex_glass",
                               region_kind="annulus", r_min_cm=0.2410, r_max_cm=0.4270),
                CellLayerPatch(id="outer_gap", role="gas_gap", material_id="helium",
                               region_kind="annulus", r_min_cm=0.4270, r_max_cm=0.4370),
                CellLayerPatch(id="outer_clad", role="cladding", material_id="ss304",
                               region_kind="annulus", r_min_cm=0.4370, r_max_cm=0.4840),
                CellLayerPatch(id="water_gap", role="inner_flow", material_id="water",
                               region_kind="annulus", r_min_cm=0.4840, r_max_cm=R_GT_INNER),
                CellLayerPatch(id="wall", role="cladding", material_id="zircaloy4",
                               region_kind="annulus", r_min_cm=R_GT_INNER, r_max_cm=R_GT_WALL_OUTER),
                CellLayerPatch(id="coolant", role="coolant", material_id="water",
                               region_kind="background"),
            ],
        ),
        ...
        UniverseSpecPatch(
            ...
            cells=[
                ...
                CellLayerPatch(id="inner_tube", role="cladding", material_id="ss304",
                               region_kind="annulus", r_min_cm=0.2140, r_max_cm=0.2310),
                CellLayerPatch(id="upper_plenum_helium", role="gas_gap", material_id="helium",
                               region_kind="annulus", r_min_cm=0.2310, r_max_cm=0.4370),
                CellLayerPatch(id="outer_clad", role="cladding", material_id="ss304",
                               region_kind="annulus", r_min_cm=0.4370, r_max_cm=0.4840),
                CellLayerPatch(id="water_gap", role="inner_flow", material_id="water",
                               region_kind="annulus", r_min_cm=0.4840, r_max_cm=R_GT_INNER),
