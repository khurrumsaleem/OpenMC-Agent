...
| VERA3_3A | 增量 + Gate 关 | runnable | assembly | 1.18547 ± 0.00217 | runnable（keff=1.18547±0.00217） | 6 |
| VERA3_3B | 增量 + Gate 关 | runnable | assembly | 1.00040 ± 0.00225 | runnable（keff=1.00040±0.00225） | 6 |
| VERA3_3B_boundarytest | 增量 + Gate 关 | — | — | 1.00130 ± 0.00230 | runnable（keff=1.00130±0.00230） | 0 |
...
- **VERA3_3A** (增量 + Gate 关): `data/runs/demo/VERA3_3A/`
- **VERA3_3B** (增量 + Gate 关): `data/runs/demo/VERA3_3B/`
- **VERA3_3B_boundarytest** (增量 + Gate 关): `data/runs/demo/VERA3_3B_boundarytest/`
